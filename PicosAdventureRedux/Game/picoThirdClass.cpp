#include "picoThirdClass.h"

PicoThirdClass::PicoThirdClass()
{
	body_ = 0;
	tips_ = 0;
...
PicoThirdClass::PicoThirdClass(const PicoThirdClass& other)
{
...
bool PicoThirdClass::setup(GraphicsManager* graphicsManager, CameraClass* camera, SoundThirdClass* soundManager)
{
	camera_ = camera;
...
void PicoThirdClass::update(float elapsedTime)
{
...
void PicoThirdClass::draw(GraphicsManager* graphicsManager, XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix, LightClass* light, bool debug)
{
	if(debug)
	{
...
void PicoThirdClass::setLevelState(int level)
{
	levelState_ = level;
}

Point PicoThirdClass::getPosition()
{
	return position_;
}

void PicoThirdClass::setPosition(Point pos)
{
	position_ = pos;
}

bool PicoThirdClass::checkPicoArrivedObjective()
{
...
bool PicoThirdClass::isPicoWaiting()
{
...
void PicoThirdClass::goToPosition(Point position)
{
...
void PicoThirdClass::makeCelebrate()
{
...
void PicoThirdClass::makeDanceAss()
{
	changeExpression("feliz");
...
void PicoThirdClass::makeGreeting()
{
	if(picoState_ == WAITING)
	{
...
void PicoThirdClass::makeLeave()
{
	goToPosition(Point(-35.25f, 0.0f, -3.0f));
	picoState_ = LEAVING;
}

void PicoThirdClass::makeNo()
{
...
void PicoThirdClass::makePointing(bool right)
{
	if(right)
	{
...
void PicoThirdClass::makeRest(bool lookCamera)
{
	if(lookCamera)
	{
...
float PicoThirdClass::approach(float goal, float current, float dt)
{
...
void PicoThirdClass::walk(float elapsedTime)
{
...
bool PicoThirdClass::lookAtCamera(bool check)
{
...
void PicoThirdClass::notify(InputManager* notifier, InputStruct arg)
{
...
void PicoThirdClass::notify(FriendSpaceShipClass* notifier, bool arg)
{
	if(arg)
	{
		makeCelebrate();
...
void PicoThirdClass::changeAnimation(std::string name, float time)
{
...
void PicoThirdClass::executeAnimation(std::string name, float time)
{
	AnimatedObject3D* animatedTemp;
	AnimatedCal3DModelClass* cal3dTemp;
...
void PicoThirdClass::changeExpression(std::string newExpression)
{
...
void PicoThirdClass::loadExpressions(GraphicsManager* graphicsManager)
{
...
void PicoThirdClass::loadConfiguration(GraphicsManager* graphicsManager)
{
	std::stringstream root;
	root << "./Data/configuration/level3/pico_configuration.xml";
