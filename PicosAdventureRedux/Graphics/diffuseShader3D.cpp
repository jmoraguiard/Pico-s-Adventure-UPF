...
DiffuseShader3DClass::DiffuseShader3DClass():Shader3DClass()
{

}

DiffuseShader3DClass::DiffuseShader3DClass(const DiffuseShader3DClass&)
{

}

DiffuseShader3DClass::~DiffuseShader3DClass()
{

}

bool DiffuseShader3DClass::setup(ID3D11Device* device)
{
	bool result;
...
bool DiffuseShader3DClass::setupShader(ID3D11Device* device, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
bool DiffuseShader3DClass::setShaderParameters(ID3D11DeviceContext* deviceContext, XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, 
...
Shader3DClass* __stdcall DiffuseShader3DClass::Create(GraphicsManager* graphicsManager)
{
	DiffuseShader3DClass* diffuseShader3DTemp = new DiffuseShader3DClass;
